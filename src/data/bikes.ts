...
const catalogue: Named[] = [
  ...
  },
  {
    ...
    ink: "#6FA8FF",
    inkAlt: "#F7D417",
    note: "A second tank ahead of the seat takes the 701 from 13 litres to 25 and adds nine kilos, which is the whole bike in one sentence. Three hundred miles between fills on a bike that still has 270 mm of clearance is a combination nothing else here offers; the weight sits high and forward, and you feel it.",
    story:
      "Sold for 2020 and 2021 only. Husqvarna then dropped the model and put the front tank in the accessory catalogue, so a late standard 701 can be made into one, and plenty have been. The underseat tank is unchanged, which is why the added mass is all above the front wheel.",
    platform: LC4_690,
  },
  {
    make: "Husqvarna",
  ...
  {
    // KTM publish no torque, weight-with-fuel, or ground clearance for this one;
    // the 165 kg is their 139 kg without fuel plus 35 litres
    make: "KTM",
  ...
  {
    // Period figures disagree: 30 L and 150 kg dry also circulate. The 28 L and
    // 163 kg here come from one source, so at least they reconcile with each other
    make: "Yamaha",
    model: "XT600Z Ténéré",
    year: "1983",
    spec: {
    ...
    ink: "#4E8CFF",
    inkAlt: "#F2F2F2",
    note: "The bike that invented this category, and forty years on the numbers still read well: 28 litres, 163 kg, a 21-inch front and 255 mm of fork travel. What it does not have is a disc on the back, a sixth gear, water cooling or any electronics at all, and 46 air-cooled horsepower is asking to be revved.",
    story:
      "Yamaha built it to sell the Paris-Dakar wins, and the 34L is the one people mean when they say Ténéré: one enormous tank, a solo seat and a fairing that looked like the works bikes. Everything on this list with a big tank and a 21-inch front is a descendant. Values have gone the way of clean 1980s Japanese bikes, so a tidy one is no longer cheap.",
  },
  {
...
const TRAVEL: Record<string, string> = {
  ...
  "husqvarna-701-enduro-lr-2020": "250 / 250 mm",
  "ktm-450-exc-f-2024": "300 / 310 mm",
  "ktm-450-rally-replica-2027": "304 / 280 mm",
  ...
  "yamaha-xt600z-tenere-1983": "255 / 236 mm",
