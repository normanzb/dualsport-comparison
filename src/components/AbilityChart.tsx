		...
		<figure className="w-full">
			...
			>
				...
				{AXES.map((a, i) => {
					...
					return (
						<circle key={a.key} cx={x} cy={y} r={3.5} fill="var(--livery)" />
					);
				})}
			...
			<figcaption className="mt-2 text-[10px] leading-relaxed text-ink-faint">
				<p className="text-ink-dim">
					Further out is better. Each axis scores against a fixed benchmark,
					never against the rest of the field.
				</p>
				<dl className="mt-2 space-y-1.5">
					{[
						...
						[
							"Highway",
							"engine size 4, wind protection 3, top-gear comfort 1.",
						],
					].map(([term, def]) => (
				...
				<p className="mt-2">
					Offroad ease, performance and highway are indices out of ten, not
					measurements. Hours-based service intervals sit at a 30 mph working
					average.
				</p>
			</figcaption>
		</figure>
